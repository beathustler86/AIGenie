...
def optimized_attention(*args, **kwargs):
    """
    Stub for legacy checkpoint compatibility.
    Replace with actual implementation if model calls this during inference.
    """
    return None
...
class CausalNormalize(torch.nn.Module):
    ...
    def forward(self, x):
        # If num_groups != 1, we apply spatio-temporal groupnorm for backward compatibility.
        # All new models should use num_groups=1 to guarantee causality.
